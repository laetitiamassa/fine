...
class HappeningsControllerTest < ActionController::TestCase
  ...
  test "should create happening" do
    assert_difference('Happening.count') do
      post :create, happening: { action: @happening.action, counterpart: @happening.counterpart, deadline: @happening.deadline, done: @happening.done, object: @happening.object }
    end
  ...
  test "should update happening" do
    patch :update, id: @happening, happening: { action: @happening.action, counterpart: @happening.counterpart, deadline: @happening.deadline, done: @happening.done, object: @happening.object }
    assert_redirected_to happening_path(assigns(:happening))
  end
